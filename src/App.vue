...
*熟练使用angularjs、vuejs、jqueryui、elementui等主流架及组件，实现代码的模块化，组件的开发与封装
...
1. 2016/7--2017/5   深圳创科信息技术有限公司-中国移动在线计费平台-技术研发部
...
* [我的GitHub](https://github.com/nahong)
 > 谢谢浏览,这里仅用vuejs展示一个vue以及css3属性的一些应用，详细情况请以简历为准。
